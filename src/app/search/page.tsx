  ...
  if (!decodedQuery) {
    return (
      <div className="max-w-7xl mx-auto p-5">
        ...
        <p className="text-gray-500">Enter a search term to find movies and TV shows.</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto p-5">
              ...
              return (
                ...
                >
                  {posterUrl ? (
                    ...
                    <div className="w-full h-[450px] bg-slate-700 rounded-lg flex items-center justify-center">
      ...
      {movies.length === 0 && tvShows.length === 0 && (
        <p className="text-gray-500">No results found for "{decodedQuery}"</p>
      )}
    </div>
  );
}
